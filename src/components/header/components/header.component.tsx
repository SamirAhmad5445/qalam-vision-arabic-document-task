  ...
  <header className="bg-white shadow-md">
    <div className="container flex items-center justify-between px-8 py-4">
      ...
      <div className="flex flex-row-reverse items-center gap-3 text-right">
        <div className="grid size-10 place-content-center rounded-lg bg-gradient-to-r from-primary-600 to-primary-700 text-primary-100 shadow-lg shadow-primary-100">
          <FiletextIcon />
        </div>
        <div>
